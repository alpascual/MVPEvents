...
- (void) submitPoint:(CLLocation *) newPoint {
    if ( [self validNetworkConnection] == YES ) {        
        ...
        NSString *twitterUser = [UIDevice currentDevice].name;;
        ...
        NSString *myRequestString = [[NSString alloc] initWithFormat:@"http://tracker.alsandbox.us/api/Create?TwitterName=%@&Long=%@&Lat=%@&sHashTag=mvp12", twitterUser, Long, Lat ];
